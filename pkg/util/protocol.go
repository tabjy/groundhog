...
const (
	...
	CIPHER_AES_128_CFB byte = 0x01
	CIPHER_AES_192_CFB byte = 0x02
	CIPHER_AES_256_CFB byte = 0x03
	CIPHER_AES_128_CTR byte = 0x04
	CIPHER_AES_192_CTR byte = 0x05
	CIPHER_AES_256_CTR byte = 0x06
	CIPHER_AES_128_OFB byte = 0x07
	CIPHER_AES_192_OFB byte = 0x08
	CIPHER_AES_256_OFB byte = 0x09
)
